...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = '' 
        Entry(width=20,bg='#ccddff',font=('Arial Bold',28),
              textvariable=self.equation).place(x=0,y=0)#The Entry widget displays the current input and result at the top

        Button(width=11,height=4,text='(',relief='flat',
               bg='white',command=lambda:self.show('(')).place(x=0,y=50)
        ...
        Button(width=11,height=4,text='5',relief='flat',
               bg='white',command=lambda:self.show(5)).place(x=90,y=200)
        Button(width=11,height=4,text='6',relief='flat',
               bg='white',command=lambda:self.show(6)).place(x=180,y=200)
        Button(width=11,height=4,text='7',relief='flat',
               bg='white',command=lambda:self.show(7)).place(x=0,y=275)
